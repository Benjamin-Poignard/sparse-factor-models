function out=factor_selection(X,rmax)

% This function implements the consistent procedure
% for the determination of the number of factors described
% in Onatski (2008), 'Determining the number of factors from empirical
% distribution of eigenvalues', The Review of Economics and Statistics,
% 92(4): 1004-1016

% Inputs:
%        - X: n x T matrix, which has the factor structure X=LF'+e
%        - rmax: a priori maximal number of factors
