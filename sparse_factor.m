...
while count < max_iter
    ...
    error = norm([param_psi_update;param_lambda_update] - [param_psi;param_lambda])^2/max([1,norm([param_psi_update;param_lambda_update]),norm([param_psi_update;param_lambda])]);
    if (error <= Tol)
        break
    end
